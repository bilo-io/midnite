...
describe('CommandPalette', () => {
  ...
  it('stays closed until ⌘K, then lists every enabled surface', () => {
    ...
    // toggleable features shown (ideas off by default; digests on — Phase 62 G) +
    // 3 always-on destinations (Agents, Profile, Settings). The header `?`
    // keyboard-shortcuts control stays a plain button.
