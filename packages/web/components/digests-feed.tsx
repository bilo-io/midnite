  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? 'border-primary/60 bg-accent' : 'surface-glass-interactive hover:border-primary/40',
      )}
    >
...
export function DigestsFeed() {
  ...
  return (
    <div className="container flex-1 pb-8 pt-4" data-tour="digests-content">
      {loading && list.length === 0 ? (
        ...
        <div className="grid gap-6 md:grid-cols-[minmax(14rem,18rem)_1fr]">
          ...
          <div className="min-w-0 rounded-xl border surface-glass p-4 md:p-6">
            {effectiveId ? (
