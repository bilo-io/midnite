...
// Theme provider ported from packages/web/app/theme/theme-context.tsx. The package
// boundary forbids importing across packages, so the small amount of logic is
// duplicated here (kept deliberately identical, sharing THEME_STORAGE_KEY).
import {
  createContext,
  useCallback,
  useContext,
