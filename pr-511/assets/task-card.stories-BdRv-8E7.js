...
}`,...(z=l.parameters)===null||z===void 0||(G=z.docs)===null||G===void 0?void 0:G.source},description:{story:"Without `onSelect` the card renders as a static div instead of a button.",...(V=l.parameters)===null||V===void 0||(J=V.docs)===null||J===void 0?void 0:J.description}}};p.parameters={...p.parameters,docs:{...(X=p.parameters)===null||X===void 0?void 0:X.docs,source:{originalSource:`{
  args: {
    task: {
      ...taskFeature,
      repo: 'acme/api'
...
}`,...(ce=u.parameters)===null||ce===void 0||(de=ce.docs)===null||de===void 0?void 0:de.source},description:{story:"Phase 50 B — held because the per-hour spawn-rate cap is full.",...(pe=u.parameters)===null||pe===void 0||(le=pe.docs)===null||le===void 0?void 0:le.description}}};const qe=["Feature","Bug","WithMilestone","Question","AnsweredQuestion","Chore","UnknownKind","NonInteractive","WithRepo","HeldOverBudget","HeldRateLimited"];export{d as AnsweredQuestion,v as Bug,g as Chore,r as Feature,m as HeldOverBudget,u as HeldRateLimited,l as NonInteractive,_ as Question,c as UnknownKind,i as WithMilestone,p as WithRepo,qe as __namedExportsOrder,Ye as default};
