...
- ✅ **E** — Tests/stories/e2e: coercion + version + auto-launch gating units (A–D), `play` stories for interactive + index, a shot per guide (light+dark), a11y keyboard e2e; Verification checklist done (PR #PRNUM)
