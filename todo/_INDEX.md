...
|-------|--------|------|----------|---|--------|--------|
| [82 · Full i18n coverage sweep (en-GB + fr-FR)](phase-82-i18n-full-coverage.md) | 🔄 WIP | 14/40 | `███░░░░░░░` | 35% | — | D E F |
...
- ✅ **C** — Auth & Settings sweep (register/forgot/invite; every settings subpage; shared error/empty states) (PR #535)
