...
| [67 · Guides on every page](phase-67-guides-everywhere.md) | 🔄 WIP | 12/30 | `████░░░░░░` | 40% | — | D E |
...
- ✅ **C** — "All guides" index in the assistant panel: every guide + seen/unseen, click-to-replay (navigate off-route then start); FAB dot reflects any unseen (PR #PRNUM)
