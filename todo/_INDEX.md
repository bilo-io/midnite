...
|-------|--------|------|----------|---|--------|--------|
| [65 · Memory workspace](phase-65-memory-workspace.md) | ◻ TODO | 0/33 | `░░░░░░░░░░` | 0% | — | A B C D E F G |
...
- ◻ **A** — `/memory/view?id=` page: 3-panel shell + `GET /memories/:id` + routing/nav (modal reserved for create)
