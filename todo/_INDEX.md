...
| [67 · Guides on every page](phase-67-guides-everywhere.md) | 🔄 WIP | 9/30 | `███░░░░░░░` | 30% | — | C D E |
...
- ✅ **B** — Interactive steps: scroll anchor into view + optional `advanceOn: 'click'` action-advance through the mask; reduced-motion + a11y intact (PR #427)
