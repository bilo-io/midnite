...
| [62 · Fable-Digest](phase-62-fable-digest.md) | 🔄 WIP | 20/32 | `██████░░░░` | 63% | G | — |
...
- ◐ **H** — Transcript slicer (done in C) + `midnite retro` CLI + `retro.autoSkeleton`/`narrativeMaxTokens` config + `docs/RETROS.md` (PR #403); **`midnite digest` deferred** pending Theme G's `GET /digests`
