...
- [ ] **Remaining (uses the helper above):** the **multi-endpoint** market widgets — `market-asset`/`market-watchlist` — and `boardroom-panel`. Each needs a bit more than the list-widget pattern.
