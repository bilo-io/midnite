import{l as s}from"./iframe-BMnGZiab.js";import{a6 as f}from"./site-links-BhZk_F72.js";import{S as w}from"./source-icon-dkRduIfz.js";import"./preload-helper-Dp1pzeXC.js";import"./globe-D_IP1oQ4.js";import"./file-text-B4bQniO9.js";import"./sticky-note-QHJdh7O8.js";var n,t,c,l,m,p,u,g,_,v,k,h,x,N,G,S,b;const I={title:"Components/SourceIcon",component:w,argTypes:{kind:{control:"select",options:[...f]}}},r={args:{kind:"github",className:"h-6 w-6"}},a={args:{kind:"figma",className:"h-6 w-6"}},o={args:{kind:"google-docs",className:"h-6 w-6"}},i={args:{kind:"link",className:"h-6 w-6"}},e={args:{kind:"github"},render:()=>s.jsx("div",{className:"grid grid-cols-5 gap-x-6 gap-y-4",children:f.map(d=>s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(w,{kind:d,className:"h-5 w-5"}),s.jsx("span",{className:"text-xs text-muted-foreground",children:d})]},d))})};r.parameters={...r.parameters,docs:{...(n=r.parameters)===null||n===void 0?void 0:n.docs,source:{originalSource:`{
  args: {
    kind: 'github',
    className: 'h-6 w-6'
  }
...
}`,...(G=e.parameters)===null||G===void 0||(N=G.docs)===null||N===void 0?void 0:N.source},description:{story:"Every detected provider kind with its brand mark or lucide fallback.",...(b=e.parameters)===null||b===void 0||(S=b.docs)===null||S===void 0?void 0:S.description}}};const L=["Github","Figma","GoogleDocs","GenericLink","AllKinds"];export{e as AllKinds,a as Figma,i as GenericLink,r as Github,o as GoogleDocs,L as __namedExportsOrder,I as default};
