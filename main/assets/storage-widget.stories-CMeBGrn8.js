import{b2 as i,aU as t,aG as U}from"./iframe-DLeraoju.js";import{p as A}from"./index-C3aUEuMX.js";import{W as C}from"./spinner-DBd64yv3.js";import{W}from"./widget-card-Bi97x1Wb.js";import{D as k}from"./database-BzsdLgWz.js";import{R as F}from"./refresh-cw-Bdv87O6z.js";import"./preload-helper-Dp1pzeXC.js";import"./Select-ef7c0426.esm-B6l0Gi7I.js";import"./chevron-down-Bmrm0Egb.js";import"./check-PugQV7Rd.js";function G(){const[e,a]=i.useState(null),[I,N]=i.useState(!1),l=i.useCallback(async()=>{var d;if(typeof navigator>"u"||!(!((d=navigator.storage)===null||d===void 0)&&d.estimate)){a("unsupported");return}N(!0);try{const{usage:j=0,quota:q=0}=await navigator.storage.estimate();a({usage:j,quota:q})}catch{a("error")}finally{N(!1)}},[]);return i.useEffect(()=>{l()},[l]),t.jsx(W,{title:"App cache",icon:k,actions:t.jsx("button",{type:"button",onClick:()=>void l(),"aria-label":"Refresh cache estimate",className:"rounded-md p-1 text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground",children:t.jsx(F,{className:U("h-3 w-3",I&&"animate-spin")})}),bodyClassName:"flex flex-col items-center justify-center gap-3 p-4",children:e===null?t.jsx(C,{}):e==="unsupported"?t.jsx("p",{className:"px-2 text-center text-sm text-muted-foreground",children:"Cache estimates aren’t available in this browser."}):e==="error"?t.jsx("p",{className:"px-2 text-center text-sm text-destructive",children:"Couldn’t read cache usage."}):t.jsx(A,{usedBytes:e.usage,totalBytes:e.quota})})}G.__docgenInfo={description:`How much storage *this web app* has cached in the browser (IndexedDB /
...
}`,...(b=r.parameters)===null||b===void 0||(B=b.docs)===null||B===void 0?void 0:B.source},description:{story:"No Storage Manager API → the unsupported message.",...(T=r.parameters)===null||T===void 0||(E=T.docs)===null||E===void 0?void 0:E.description}}};const Q=["Default","NearlyFull","Unsupported"];export{s as Default,o as NearlyFull,r as Unsupported,Q as __namedExportsOrder,J as default};
