import{aX as n,ax as R}from"./iframe-Ln_xB0ra.js";import{c as N,q as x,k as B,p as j}from"./fixtures-BZzR_DAR.js";import{C as P}from"./confirm-dialog-DojFM5S0.js";import{P as H}from"./project-modal-DwuALi59.js";import"./preload-helper-Dp1pzeXC.js";import"./index-qNTqXMqE.js";import"./Select-ef7c0426.esm-CK_lkYUi.js";import"./chevron-down-CWPfPTdg.js";import"./check-jat6RuUo.js";import"./index-DZJex3cb.js";import"./triangle-alert-CVwj2ou4.js";import"./export-menu-DLy-MhYF.js";import"./client-CXVj6vsU.js";import"./markdown-preview-Dxs3Zkkx.js";import"./index.dom-D_wTd2ti.js";import"./file-text-CH2Q2Q6Y.js";import"./copy-1lYeykor.js";import"./file-code-corner-A5VndpDq.js";import"./loader-circle-BizL0gkJ.js";import"./api-COfa-pOQ.js";import"./folder-open-8M75wjFf.js";import"./folder-4Cmy0tXD.js";import"./tag-color-picker-rq1-qvxr.js";import"./project-tag-Bqx9jN0o.js";import"./sparkles-ldPr6BJs.js";import"./brain-BCzHavJY.js";import"./chevron-right-fiR9hBzQ.js";import"./markdown-editor-BD0P70BL.js";import"./pencil-BjMBPf6N.js";import"./trash-2-DlMMwR-p.js";import"./templates-B6M1OYb3.js";import"./plus-DMQTfjVN.js";import"./task-row-DqnvcNMp.js";import"./blocked-badge-BaDOCUXB.js";import"./selectable-icon-DQjeOqEu.js";import"./task-columns-DXf2yYcn.js";import"./refresh-cw-D-SYDsLT.js";import"./arrow-left-wAocPLMj.js";var s,c,p,l,d,m,v,u,_,w,g,y,T,E,b;const{expect:f,fn:h,userEvent:C,within:t}=__STORYBOOK_MODULE_TEST__,ya={title:"Components/ProjectModal",component:H,args:{onClose:h(),onSaved:h()},decorators:[a=>n.jsx(R,{children:n.jsx(P,{children:n.jsx(a,{})})})]},o={args:{project:null},play:async({canvasElement:a})=>{const e=await t(a).findByRole("dialog",{name:"New project"});await f(t(e).getByLabelText("Title")).toHaveValue("")}},i={args:{project:j,tasks:[x,B],memories:[N],onSelectTask:h()},play:async({canvasElement:a})=>{const e=await t(a).findByRole("dialog",{name:"Edit project"});await f(t(e).getByLabelText("Title")).toHaveValue(j.name)}},r={args:{project:j,tasks:[x,B]},play:async({canvasElement:a})=>{const e=await t(a).findByRole("dialog",{name:"Edit project"}),S=t(e).getByRole("tab",{name:/plan/i});await C.click(S),await f(S).toHaveAttribute("aria-selected","true")}};o.parameters={...o.parameters,docs:{...(s=o.parameters)===null||s===void 0?void 0:s.docs,source:{originalSource:`{
  args: {
    project: null
  },
  play: async ({
