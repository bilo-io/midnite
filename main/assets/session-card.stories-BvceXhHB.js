import{l as e}from"./iframe-CwktqEBX.js";import{g as B,s as H,h as d,i as K,j as M,e as U}from"./fixtures-BZzR_DAR.js";import{S as Y,a as q,b as z}from"./session-card-D-USz3wG.js";import"./preload-helper-Dp1pzeXC.js";import"./index-BFWRHuWc.js";import"./index-DTBfnkv9.js";import"./index-BDiFekjL.js";import"./Select-ef7c0426.esm-DDDnBsy0.js";import"./chevron-down-DGQAhRwB.js";import"./check-BNxS9ALI.js";import"./project-tag-xXy7Qo_c.js";import"./site-links-pM9JTGsI.js";import"./selectable-icon-CEkDGkcF.js";import"./bot-message-square-1mXkrT-O.js";import"./arrow-up-right-DMhYhav6.js";var l,c,m,p,u,v,g,_,x,y,S,w,R,j,h,N,f,C,I,k,L,b,T,D;const{expect:A,fn:E,userEvent:F,within:G}=__STORYBOOK_MODULE_TEST__,ds={title:"Components/SessionCard",component:Y,args:{onClick:E()}},o={args:{session:d,layout:"grid"},decorators:[s=>e.jsx("div",{className:"max-w-xs",children:e.jsx(s,{})})],play:async({args:s,canvasElement:O})=>{const W=G(O);await F.click(W.getByText(d.title)),await A(s.onClick).toHaveBeenCalledOnce()}},i={args:{session:K,layout:"grid"},decorators:[s=>e.jsx("div",{className:"max-w-xs",children:e.jsx(s,{})})]},t={args:{session:H,layout:"list"},decorators:[s=>e.jsx("div",{className:"max-w-2xl",children:e.jsx(s,{})})]},a={args:{session:B,layout:"grid"},decorators:[s=>e.jsx("div",{className:"max-w-xs",children:e.jsx(s,{})})]},r={args:{session:d,layout:"list"},render:()=>e.jsx("div",{className:"max-w-3xl rounded-lg border border-border/60",children:M.map(s=>e.jsx(q,{session:s,project:U,onClick:E()},s.id))})},n={args:{session:d,layout:"grid"},render:()=>e.jsx("div",{className:"flex items-center gap-6",children:["running","waiting","completed","idle"].map(s=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(z,{status:s}),e.jsx("span",{className:"text-xs text-muted-foreground",children:s})]},s))})};o.parameters={...o.parameters,docs:{...(l=o.parameters)===null||l===void 0?void 0:l.docs,source:{originalSource:`{
  args: {
...
}`,...(D=n.parameters)===null||D===void 0||(T=D.docs)===null||T===void 0?void 0:T.source}}};const ls=["Running","Waiting","ListLayout","Idle","Rows","StatusDots"];export{a as Idle,t as ListLayout,r as Rows,o as Running,n as StatusDots,i as Waiting,ls as __namedExportsOrder,ds as default};
