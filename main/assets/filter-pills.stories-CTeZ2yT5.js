import{H as te,F as se,I as re,r as n,n as s,e as v}from"./iframe-DLK6r6p_.js";import{r as ae}from"./index-DifjHr3G.js";import{C as oe}from"./chevron-down-CTeTdGaH.js";import{C as G}from"./check-DNPejkj4.js";import{C as ne}from"./task-columns-DXf2yYcn.js";import"./preload-helper-Dp1pzeXC.js";const h=r=>r.color?r.color:r.hue?`hsl(${r.hue})`:null;function K({options:r,paramKey:m="status",allLabel:D="All",hideAll:W=!1,placeholder:f,countNoun:J="selected",className:X}){const V=te(),x=se(),w=re(),[l,b]=n.useState(!1),[j,Y]=n.useState(null),y=n.useRef(null),H=n.useRef(null),Z=new Set(r.map(e=>e.value)),M=w.get(m),g=new Set((M?M.split(","):[]).filter(e=>Z.has(e))),i=r.filter(e=>g.has(e.value)),U=g.size===0,c=n.useCallback(()=>{const e=y.current;if(!e)return;const t=e.getBoundingClientRect();Y({top:t.bottom+4,left:t.left})},[]);n.useEffect(()=>{if(!l)return;c();const e=a=>{var o,S;const I=a.target;!((o=y.current)===null||o===void 0)&&o.contains(I)||!((S=H.current)===null||S===void 0)&&S.contains(I)||b(!1)},t=a=>{a.key==="Escape"&&b(!1)};return window.addEventListener("scroll",c,!0),window.addEventListener("resize",c),document.addEventListener("mousedown",e),document.addEventListener("keydown",t),()=>{window.removeEventListener("scroll",c,!0),window.removeEventListener("resize",c),document.removeEventListener("mousedown",e),document.removeEventListener("keydown",t)}},[l,c]);const B=n.useCallback(e=>{const t=new URLSearchParams(w.toString());e.size===0?t.delete(m):t.set(m,r.filter(o=>e.has(o.value)).map(o=>o.value).join(","));const a=t.toString();V.replace(a?`${x}?${a}`:x,{scroll:!1})},[V,x,w,m,r]),ee=e=>{const t=new Set(g);t.has(e)?t.delete(e):t.add(e),B(t)};return s.jsxs("div",{className:v("relative",X),children:[s.jsxs("button",{ref:y,type:"button",onClick:()=>b(e=>!e),"aria-haspopup":"listbox","aria-expanded":l,className:v("inline-flex h-8 items-center gap-1.5 rounded-md border border-input bg-background px-2.5 text-xs font-medium transition-colors hover:bg-accent/50",l&&"ring-1 ring-ring"),children:[i.length===0?s.jsx("span",{className:"text-muted-foreground",children:f??D}):s.jsxs("span",{className:"flex items-center gap-1.5 text-foreground",children:[i.some(e=>h(e))?s.jsx("span",{className:"flex -space-x-1",children:i.slice(0,4).map(e=>h(e)&&s.jsx("span",{"aria-hidden":!0,className:"h-2.5 w-2.5 rounded-full ring-1 ring-background",style:{background:h(e)}},e.value))}):null,i.length===1?i[0].label:`${i.length} ${J}`]}),s.jsx(oe,{className:v("h-3.5 w-3.5 text-muted-foreground transition-transform",l&&"rotate-180")})]}),l&&j?ae.createPortal(s.jsxs("div",{ref:H,role:"listbox","aria-multiselectable":!0,style:{position:"fixed",top:j.top,left:j.left},className:"z-[60] max-h-72 w-56 overflow-auto rounded-md border border-border bg-card p-1 shadow-lg",children:[W?null:s.jsxs("button",{type:"button",role:"option","aria-selected":U,onClick:()=>B(new Set),className:"flex w-full items-center gap-2 rounded px-2 py-1.5 text-xs text-muted-foreground hover:bg-accent/60 hover:text-foreground",children:[s.jsx("span",{className:"flex h-3.5 w-3.5 items-center justify-center",children:U?s.jsx(G,{className:"h-3.5 w-3.5"}):null}),D]}),r.map(e=>{const t=g.has(e.value),a=h(e);return s.jsxs("button",{type:"button",role:"option","aria-selected":t,onClick:()=>ee(e.value),className:v("flex w-full items-center gap-2 rounded px-2 py-1.5 text-xs hover:bg-accent/60",t?"text-foreground":"text-muted-foreground hover:text-foreground"),children:[s.jsx("span",{className:"flex h-3.5 w-3.5 items-center justify-center",children:t?s.jsx(G,{className:"h-3.5 w-3.5"}):null}),a?s.jsx("span",{"aria-hidden":!0,className:"h-2.5 w-2.5 shrink-0 rounded-full",style:{background:a}}):null,s.jsx("span",{className:"truncate",children:e.label})]},e.value)})]}),document.body):null]})}K.__docgenInfo={description:`A themed multi-select dropdown backed by the URL query string (default
...
}`,...(F=p.parameters)===null||F===void 0||(O=F.docs)===null||O===void 0?void 0:O.source},description:{story:"Options can carry raw hex colors instead of status hues (e.g. projects).",...(z=p.parameters)===null||z===void 0||($=z.docs)===null||$===void 0?void 0:$.description}}};const ve=["NoneSelected","SomeSelected","ProjectColors"];export{d as NoneSelected,p as ProjectColors,u as SomeSelected,ve as __namedExportsOrder,ge as default};
