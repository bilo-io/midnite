import{r as i,n as t,e as A}from"./iframe-DLK6r6p_.js";import{R as C}from"./radial-gauge-BDgWp-mE.js";import{W as U}from"./spinner-wIUMpr-Y.js";import{W}from"./widget-card-DsjAdUyB.js";import{D as k}from"./database-DTLaFTXy.js";import{R as F}from"./refresh-cw-F1VlBrrs.js";import"./preload-helper-Dp1pzeXC.js";function G(){const[e,a]=i.useState(null),[I,N]=i.useState(!1),l=i.useCallback(async()=>{var d;if(typeof navigator>"u"||!(!((d=navigator.storage)===null||d===void 0)&&d.estimate)){a("unsupported");return}N(!0);try{const{usage:j=0,quota:q=0}=await navigator.storage.estimate();a({usage:j,quota:q})}catch{a("error")}finally{N(!1)}},[]);return i.useEffect(()=>{l()},[l]),t.jsx(W,{title:"App cache",icon:k,actions:t.jsx("button",{type:"button",onClick:()=>void l(),"aria-label":"Refresh cache estimate",className:"rounded-md p-1 text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground",children:t.jsx(F,{className:A("h-3 w-3",I&&"animate-spin")})}),bodyClassName:"flex flex-col items-center justify-center gap-3 p-4",children:e===null?t.jsx(U,{}):e==="unsupported"?t.jsx("p",{className:"px-2 text-center text-sm text-muted-foreground",children:"Cache estimates aren’t available in this browser."}):e==="error"?t.jsx("p",{className:"px-2 text-center text-sm text-destructive",children:"Couldn’t read cache usage."}):t.jsx(C,{usedBytes:e.usage,totalBytes:e.quota})})}G.__docgenInfo={description:`How much storage *this web app* has cached in the browser (IndexedDB /
...
}`,...(b=r.parameters)===null||b===void 0||(B=b.docs)===null||B===void 0?void 0:B.source},description:{story:"No Storage Manager API → the unsupported message.",...(T=r.parameters)===null||T===void 0||(E=T.docs)===null||E===void 0?void 0:E.description}}};const Y=["Default","NearlyFull","Unsupported"];export{s as Default,o as NearlyFull,r as Unsupported,Y as __namedExportsOrder,V as default};
