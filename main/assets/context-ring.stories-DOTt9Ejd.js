import{n as o}from"./iframe-D56zeehm.js";import{C as w}from"./context-ring-ByWuGfZQ.js";import"./preload-helper-Dp1pzeXC.js";var i,n,d,l,m,p,c,_,v,u,g,x,h,f,k,L,M,H;const C={title:"Components/ContextRing",component:w},e={args:{tokens:42e3,limit:2e5}},r={args:{tokens:13e4,limit:2e5}},s={args:{tokens:184e3,limit:2e5}},a={args:{tokens:42e3,limit:2e5},render:()=>o.jsx("div",{className:"flex items-center gap-6",children:[12e3,42e3,104e3,13e4,168e3,184e3,2e5].map(t=>o.jsxs("div",{className:"flex flex-col items-center gap-1.5",children:[o.jsx(w,{tokens:t,limit:2e5}),o.jsxs("span",{className:"text-[10px] tabular-nums text-muted-foreground",children:[Math.round(t/2e5*100),"%"]})]},t))})};e.parameters={...e.parameters,docs:{...(i=e.parameters)===null||i===void 0?void 0:i.docs,source:{originalSource:`{
  args: {
    tokens: 42_000,
    limit: 200_000
  }
