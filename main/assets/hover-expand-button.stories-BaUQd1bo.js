import{l as t}from"./iframe-CwktqEBX.js";import{H as P,P as B}from"./hover-expand-button-B1wxzFw_.js";import{O as f}from"./octagon-x-rFZbHK2J.js";import{W as E}from"./workflow-rkrT_hRG.js";import"./preload-helper-Dp1pzeXC.js";import"./index-BFWRHuWc.js";import"./index-DTBfnkv9.js";import"./index-BDiFekjL.js";import"./Select-ef7c0426.esm-DDDnBsy0.js";import"./chevron-down-DGQAhRwB.js";import"./check-BNxS9ALI.js";var r,l,n,i,c,d,p,m,u,h,v,g,_,y;const{expect:x,within:S}=__STORYBOOK_MODULE_TEST__,z={title:"Components/HoverExpandButton",component:P,parameters:{layout:"centered",docs:{description:{component:`A control-bar action that shows only its icon and expands to reveal its label on
...
}`,...(u=o.parameters)===null||u===void 0||(m=u.docs)===null||m===void 0?void 0:m.source}}};e.parameters={...e.parameters,docs:{...(h=e.parameters)===null||h===void 0?void 0:h.docs,source:{originalSource:`{
  args: {
    icon: <Pause className="h-3.5 w-3.5" />,
    label: 'Pause scheduling',
    variant: 'ghost'
...
don't engage \`:hover\`.`,...(y=e.parameters)===null||y===void 0||(_=y.docs)===null||_===void 0?void 0:_.description}}};const W=["Graph","Pause_","EmergencyStop","CollapsedByDefault"];export{e as CollapsedByDefault,o as EmergencyStop,a as Graph,s as Pause_,W as __namedExportsOrder,z as default};
