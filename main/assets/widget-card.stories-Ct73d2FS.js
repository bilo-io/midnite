import{n as e}from"./iframe-pMjuI2BH.js";import{W as u}from"./widget-card-BCPnMaqO.js";import{N as m}from"./newspaper-Bbixx0BL.js";import{R as h}from"./refresh-cw-CGiO1II2.js";import"./preload-helper-Dp1pzeXC.js";var s,a,o,i,n,d,c,l;const w={title:"Components/WidgetCard",component:u,decorators:[p=>e.jsx("div",{className:"h-48 max-w-sm",children:e.jsx(p,{})})]},r={args:{title:"Latest news",icon:m,children:e.jsx("p",{className:"p-4 text-sm text-muted-foreground",children:"Three new headlines."})}},t={args:{title:"Latest news",icon:m,actions:e.jsx("button",{type:"button","aria-label":"Refresh",className:"text-muted-foreground hover:text-foreground",children:e.jsx(h,{className:"h-3.5 w-3.5"})}),children:e.jsx("p",{className:"p-4 text-sm text-muted-foreground",children:"Three new headlines."})}};r.parameters={...r.parameters,docs:{...(s=r.parameters)===null||s===void 0?void 0:s.docs,source:{originalSource:`{
  args: {
    title: 'Latest news',
    icon: Newspaper,
