import{aU as e}from"./iframe-B0rFGTko.js";import{g as B,s as H,h as d,i as U,j as K,e as M}from"./fixtures-BZzR_DAR.js";import{S as Y,a as q,b as z}from"./session-card-Bx7e7WMn.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CsceVdZB.js";import"./index-B5xUfJwv.js";import"./Select-ef7c0426.esm-DniCoGHs.js";import"./chevron-down-DE3p_e72.js";import"./check-Du1Ve39s.js";import"./project-tag-73cdOjgp.js";import"./selectable-icon-B8W-x6EP.js";import"./bot-message-square-CmtwfZSW.js";import"./arrow-up-right-BSquD8xB.js";var l,c,m,p,u,v,g,_,x,y,S,w,R,j,h,N,f,C,I,k,L,b,T,D;const{expect:A,fn:E,userEvent:F,within:G}=__STORYBOOK_MODULE_TEST__,ts={title:"Components/SessionCard",component:Y,args:{onClick:E()}},o={args:{session:d,layout:"grid"},decorators:[s=>e.jsx("div",{className:"max-w-xs",children:e.jsx(s,{})})],play:async({args:s,canvasElement:O})=>{const W=G(O);await F.click(W.getByText(d.title)),await A(s.onClick).toHaveBeenCalledOnce()}},i={args:{session:U,layout:"grid"},decorators:[s=>e.jsx("div",{className:"max-w-xs",children:e.jsx(s,{})})]},t={args:{session:H,layout:"list"},decorators:[s=>e.jsx("div",{className:"max-w-2xl",children:e.jsx(s,{})})]},a={args:{session:B,layout:"grid"},decorators:[s=>e.jsx("div",{className:"max-w-xs",children:e.jsx(s,{})})]},r={args:{session:d,layout:"list"},render:()=>e.jsx("div",{className:"max-w-3xl rounded-lg border border-border/60",children:K.map(s=>e.jsx(q,{session:s,project:M,onClick:E()},s.id))})},n={args:{session:d,layout:"grid"},render:()=>e.jsx("div",{className:"flex items-center gap-6",children:["running","waiting","completed","idle"].map(s=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(z,{status:s}),e.jsx("span",{className:"text-xs text-muted-foreground",children:s})]},s))})};o.parameters={...o.parameters,docs:{...(l=o.parameters)===null||l===void 0?void 0:l.docs,source:{originalSource:`{
  args: {
