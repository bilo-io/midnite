...
}`,...(h=i.parameters)===null||h===void 0||(x=h.docs)===null||x===void 0?void 0:x.source},description:{story:"Spend, daily bars, and the provider/feature breakdowns from the gateway.",...(f=i.parameters)===null||f===void 0||(g=f.docs)===null||g===void 0?void 0:g.description}}};c.parameters={...c.parameters,docs:{...(_=c.parameters)===null||_===void 0?void 0:_.docs,source:{originalSource:`{
  beforeEach: () => installMockFetch([{
    match: '/usage/summary',
    json: {
      ...SUMMARY,
...
}`,...(T=c.parameters)===null||T===void 0||(b=T.docs)===null||b===void 0?void 0:b.source},description:{story:"A breached budget surfaces the warning banner.",...(w=c.parameters)===null||w===void 0||(k=w.docs)===null||k===void 0?void 0:k.description}}};l.parameters={...l.parameters,docs:{...(B=l.parameters)===null||B===void 0?void 0:B.docs,source:{originalSource:`{
  beforeEach: () => installMockFetch([{
    match: '/usage/summary',
    json: {
      ...SUMMARY,
...
}`,...(E=l.parameters)===null||E===void 0||(j=E.docs)===null||j===void 0?void 0:j.source},description:{story:"No calls recorded → the explanatory empty copy instead of breakdowns.",...(N=l.parameters)===null||N===void 0||(D=N.docs)===null||D===void 0?void 0:D.description}}};u.parameters={...u.parameters,docs:{...(U=u.parameters)===null||U===void 0?void 0:U.docs,source:{originalSource:`{
  beforeEach: () => installMockFetch([{
    match: '/usage/summary',
    status: 500
  }]),
...
}`,...(C=u.parameters)===null||C===void 0||(L=C.docs)===null||L===void 0?void 0:L.source},description:{story:"Gateway `/usage/summary` fails → the error fallback.",...(I=u.parameters)===null||I===void 0||(M=I.docs)===null||M===void 0?void 0:M.description}}};const me=["Default","OverBudget","NoCalls","Error"];export{i as Default,u as Error,l as NoCalls,c as OverBudget,me as __namedExportsOrder,ue as default};
