import{l as x}from"./iframe-CwktqEBX.js";import{L as f}from"./library-modal-Ba8bgpBZ.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DTBfnkv9.js";import"./index-BDiFekjL.js";import"./Select-ef7c0426.esm-DDDnBsy0.js";import"./chevron-down-DGQAhRwB.js";import"./check-BNxS9ALI.js";import"./book-open-D19Z8hOq.js";import"./search-CE5i4uND.js";import"./external-link-Tar1LwaJ.js";var i,l,d,m,p,v,u,h,y,_,w,g,b;const{expect:r,fn:C,userEvent:B,within:c}=__STORYBOOK_MODULE_TEST__,N={title:"Office/LibraryModal",component:f,args:{onClose:C()},decorators:[e=>x.jsx("div",{className:"relative h-[600px] w-full overflow-hidden rounded-lg border border-border",children:x.jsx(e,{})})]},s={play:async({canvasElement:e})=>{const o=await c(e).findByRole("dialog",{name:"Library"});await r(c(o).getByRole("heading",{name:"Library"})).toBeInTheDocument()}},t={play:async({canvasElement:e})=>{const a=c(e),o=a.getByRole("searchbox",{name:"Search books"});await B.type(o,"zzzzznotabook"),await r(a.getByText("No books match your search.")).toBeInTheDocument(),await B.clear(o),await r(a.queryByText("No books match your search.")).not.toBeInTheDocument()}},n={play:async({args:e,canvasElement:a})=>{const o=c(a);await B.click(o.getByRole("button",{name:"Close"})),await r(e.onClose).toHaveBeenCalledOnce()}};s.parameters={...s.parameters,docs:{...(i=s.parameters)===null||i===void 0?void 0:i.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
