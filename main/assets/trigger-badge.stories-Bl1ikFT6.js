import{aX as e}from"./iframe-CDgWhdIn.js";import{T as t}from"./trigger-badge-CFZ1EDWU.js";import"./preload-helper-Dp1pzeXC.js";import"./webhook-tCKZZ2y9.js";import"./clock-DYkkE_D-.js";var n,l,i,d,p,m,c,g,u,v,_,k;const E={title:"Components/TriggerBadge",component:t},r={args:{type:"manual"}},a={args:{type:"webhook"}},s={args:{type:"task-event"}},o={args:{type:"manual"},render:()=>e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(t,{type:"manual"}),e.jsx(t,{type:"webhook"}),e.jsx(t,{type:"task-event"})]})};r.parameters={...r.parameters,docs:{...(n=r.parameters)===null||n===void 0?void 0:n.docs,source:{originalSource:`{
  args: {
    type: 'manual'
  }
