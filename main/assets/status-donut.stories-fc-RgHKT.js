import{S as P,s as f}from"./status-donut-BotzAc3S.js";import"./iframe-DC3zcxlt.js";import"./preload-helper-Dp1pzeXC.js";import"./task-columns-DXf2yYcn.js";var r,s,n,d,p,u,i,l,c,m,_,v,g,S;function y(L){return f(new Map(L))}const E=y([["backlog",3],["todo",5],["wip",2],["waiting",1],["done",8]]),C={title:"Components/StatusDonut",component:P},t={args:{counts:E,total:19}},o={args:{counts:y([]),total:0}},a={args:{counts:y([["done",7]]),total:7}},e={args:{counts:E,total:19,size:160}};t.parameters={...t.parameters,docs:{...(r=t.parameters)===null||r===void 0?void 0:r.docs,source:{originalSource:`{
  args: {
    counts: populated,
    total: 19
  }
