import{aX as n,ax as R}from"./iframe-2OGF1UZZ.js";import{c as N,q as x,k as B,p as j}from"./fixtures-BZzR_DAR.js";import{C as P}from"./confirm-dialog-CeMjIeWC.js";import{P as H}from"./project-modal-CktnVZIY.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DMeFtEgl.js";import"./Select-ef7c0426.esm-DRnXpgYL.js";import"./chevron-down-BwSNIjGu.js";import"./check-Bykaflmc.js";import"./index-BMuGDce6.js";import"./triangle-alert-BX87LVRj.js";import"./export-menu-CLe4r0rd.js";import"./client-B_nUpCIh.js";import"./markdown-preview-B1UIFFhw.js";import"./index.dom-D_wTd2ti.js";import"./file-text-DMdWZVUW.js";import"./copy-DpiuAjBB.js";import"./file-code-corner-Cmg7ZsDf.js";import"./loader-circle-Dfi1e4dD.js";import"./api-CwbHc1_y.js";import"./folder-open-DuDJ49To.js";import"./folder-kljSWZmb.js";import"./tag-color-picker-Dhauy5eu.js";import"./project-tag-BB-Alg7I.js";import"./sparkles-BN8C-9QN.js";import"./brain-ColODwLz.js";import"./chevron-right-DaB_C7iG.js";import"./markdown-editor-BEbxDXKs.js";import"./pencil-sJKTOYtO.js";import"./trash-2-3SpWNrMf.js";import"./templates-B6M1OYb3.js";import"./plus--d-063ai.js";import"./task-row-1wlGDakh.js";import"./blocked-badge-BXc9ck8y.js";import"./selectable-icon-DktusrON.js";import"./task-columns-DXf2yYcn.js";import"./refresh-cw-DC-zy7_X.js";import"./arrow-left-C09wMVzr.js";var s,c,p,l,d,m,v,u,_,w,g,y,T,E,b;const{expect:f,fn:h,userEvent:C,within:t}=__STORYBOOK_MODULE_TEST__,ya={title:"Components/ProjectModal",component:H,args:{onClose:h(),onSaved:h()},decorators:[a=>n.jsx(R,{children:n.jsx(P,{children:n.jsx(a,{})})})]},o={args:{project:null},play:async({canvasElement:a})=>{const e=await t(a).findByRole("dialog",{name:"New project"});await f(t(e).getByLabelText("Title")).toHaveValue("")}},i={args:{project:j,tasks:[x,B],memories:[N],onSelectTask:h()},play:async({canvasElement:a})=>{const e=await t(a).findByRole("dialog",{name:"Edit project"});await f(t(e).getByLabelText("Title")).toHaveValue(j.name)}},r={args:{project:j,tasks:[x,B]},play:async({canvasElement:a})=>{const e=await t(a).findByRole("dialog",{name:"Edit project"}),S=t(e).getByRole("tab",{name:/plan/i});await C.click(S),await f(S).toHaveAttribute("aria-selected","true")}};o.parameters={...o.parameters,docs:{...(s=o.parameters)===null||s===void 0?void 0:s.docs,source:{originalSource:`{
  args: {
    project: null
  },
  play: async ({
