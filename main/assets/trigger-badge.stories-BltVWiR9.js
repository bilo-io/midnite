import{n as e}from"./iframe-Bv7TZnSa.js";import{T as t}from"./trigger-badge-BMjE0qhr.js";import"./preload-helper-Dp1pzeXC.js";import"./webhook-DqD1AtJ3.js";import"./clock-D6baanRC.js";var l,d,n,i,p,m,c,u,g,_,v,h;const S={title:"Components/TriggerBadge",component:t},r={args:{type:"manual"}},a={args:{type:"schedule"}},o={args:{type:"webhook"}},s={args:{type:"manual"},render:()=>e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(t,{type:"manual"}),e.jsx(t,{type:"schedule"}),e.jsx(t,{type:"webhook"})]})};r.parameters={...r.parameters,docs:{...(l=r.parameters)===null||l===void 0?void 0:l.docs,source:{originalSource:`{
  args: {
    type: 'manual'
  }
